class Day19 {
    ...
    public static List<Scanner> ReadScannersFromInput(StreamReader sr) {
    ...
    public static (int, int ,int) RotateBeacon((int, int, int) position, char dimension, double angle) {
        var (x, y, z) = position;
        int i, j, k;
    ...
    public static Beacon ReflectBeacon(Beacon beacon, double angle, int rotateIndex) {
    ...
    public static void MapScanners(List<Scanner> scanners) {
    ...
    public static int CalculateManhattanDistance(Scanner scanner1, Scanner scanner2) {
