class Day14 {
    ...
    public static (Dictionary<char, long>, Dictionary<string,char>, Dictionary<string, long>) ReadInput(StreamReader sr) {
    ...
    public static Dictionary<string, long> NextReaction(Dictionary<char, long> elements, Dictionary<string, long> activePairs, Dictionary<string, char> insertionRules) {
    ...
    public static void PrintElementCount(Dictionary<char, long> elements) {
        foreach(char element in elements.Keys) {
            Console.WriteLine($"{element} occurs {elements[element]} times");
        }
    }

    public static long ScorePolymer(Dictionary<char, long> elements) {
